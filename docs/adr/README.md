...
**It holds eleven decisions in force.** `ADR-001`, `ADR-002`, `ADR-003`, `ADR-005`, `ADR-006`,
`ADR-010`, `ADR-013`, `ADR-012` — since 2026-09-04 — `ADR-014` — since 2026-09-11 — `ADR-015` —
since 2026-09-14 — and **`ADR-016`, since 2026-09-15**, are all **Accepted**; **`ADR-017` is
`Proposed` — drafted, under review, and *not* in force** (issue #131), so **the count of decisions
in force remains eleven**; and every remaining
