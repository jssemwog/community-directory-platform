...
`ADR-010`, `ADR-013` and — since 2026-09-04 — `ADR-012` are all **Accepted**; **`ADR-014` is
`Proposed`** and therefore **not** in force; every remaining
