...
**~~`OQ-6`~~ · ~~`OQ-7`~~ · ~~`OQ-10`~~ · `OQ-13` · ~~`NOQ-3`~~ · `OQ-9` · `NOQ-5`** — `OQ-6`, `OQ-7`, `NOQ-3`, and `OQ-10` are now **Decided**.
...
hard blockers outright: they **must be answered before data design starts.** **Two are now
Decided (`OQ-6`, `OQ-7`) and a third — `OQ-10` — was decided on 2026-08-02; three hard blockers
remain unanswered on this gate, so `DG-1` does not clear.**
