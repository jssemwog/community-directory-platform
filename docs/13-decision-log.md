...
**~~`OQ-6`~~ · ~~`OQ-7`~~ · ~~`OQ-10`~~ · `OQ-13` · ~~`NOQ-3`~~ · `OQ-9` · `NOQ-5`** — `OQ-6`, `OQ-7`, `NOQ-3`, and `OQ-10` are now **Decided**, as are `OQ-8`/`OQ-8b` and `OQ-11`, which were not on this list of seven but were `DG-1` hard blockers. **`OQ-13`, `OQ-9`, and `NOQ-5` remain.**
...
hard blockers outright: they **must be answered before data design starts.** **Five are now
Decided** — `OQ-6` and `OQ-7` (2026-07-31), `OQ-10` (2026-08-02), `OQ-8`/`OQ-8b`
(2026-08-03), and `OQ-11` (2026-08-04). **One hard blocker remains unanswered on this gate
— `OQ-13` — so `DG-1` does not clear.** `OQ-13` is now the **sole unresolved `DG-1` row**,
and `ADR-006` is **Blocked by `OQ-13` alone**.
...
> applies: the six hard-blocker rows are unchanged, and `OQ-13` is now the **sole**
> unresolved row. **`DG-1` still does not clear.**
