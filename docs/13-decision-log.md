...
| **`DG-1`** | **Data design** | **Joe S.** — product owner | **Unresolved** | **All of `P1`**; transitively `P2`, `P3`, `P4` | 6 — **4 Decided, 2 Unresolved** (`OQ-11`, `OQ-13`) | 2 |
...
**~~`OQ-6`~~ · ~~`OQ-7`~~ · ~~`OQ-10`~~ · `OQ-13` · ~~`NOQ-3`~~ · `OQ-9` · `NOQ-5`** — `OQ-6`, `OQ-7`, `NOQ-3`, and `OQ-10` are now **Decided**, as is `OQ-8`/`OQ-8b`, which was not on this list of seven but was a `DG-1` hard blocker. **`OQ-13`, `OQ-9`, and `NOQ-5` remain.**
...
hard blockers outright: they **must be answered before data design starts.** **Four are now
Decided** — `OQ-6` and `OQ-7` (2026-07-31), `OQ-10` (2026-08-02), and `OQ-8`/`OQ-8b`
(2026-08-03). **Two hard blockers remain unanswered on this gate — `OQ-11` and `OQ-13` — so
`DG-1` does not clear.**
